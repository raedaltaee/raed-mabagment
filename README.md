...
<body>
    ...
    <script type="module">
        ...
        async function deleteCorrespondenceFromFirestore(id) {
            if (!isAuthReady) {
        ...
        activitiesForm.addEventListener('submit', async (event) => {
            event.preventDefault();
            const newItem = {
